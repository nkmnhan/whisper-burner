...
public sealed class RecordingManager : IDisposable
{
    ...
    private readonly TranscriptionClient _transcription;
    ...
    public RecordingManager(RecordingService recording, TranscriptionClient transcription, SubtitleService subtitle)
    {
